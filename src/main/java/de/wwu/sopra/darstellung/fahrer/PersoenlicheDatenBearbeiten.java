...
public class PersoenlicheDatenBearbeiten extends Scene {
	...
	public PersoenlicheDatenBearbeiten(Stage primaryStage, double width, double height) {
		...
		root.setCenter(new Label("this is person bearbeiten"));
	}
	...
	private Button setBtPersoenlicheDatenBearbeiten() {
		if (btPersoenlicheDatenBearbeiten == null) {
			...
			btPersoenlicheDatenBearbeiten.setOnAction(e -> {
				// primaryStage.setScene(new PersoenlicheDatenBearbeiten(primaryStage,
				// getWidth(), getHeight()));
			});
		}
