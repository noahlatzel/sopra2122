...
public class PersoenlicheDatenAnzeigen extends Scene {
	...
	public PersoenlicheDatenAnzeigen(Stage primaryStage, double width, double height) {
		...
		root.setCenter(new Label("this is Personliche DAeten"));
	}
	...
	private Button setBtPersoenlicheDatenAnzeigen() {
		if (btPersoenlicheDatenAnzeigen == null) {
			...
			btPersoenlicheDatenAnzeigen.setOnAction(e -> {
				// primaryStage.setScene(new PersoenlicheDatenAnzeigen(primaryStage, getWidth(),
				// getHeight()));
			});
		}
