...
public class Anmeldungssteuerung {
	...
	public void leiteWeiter(Benutzer benutzer) {
		...
		case FAHRER:
			...
			break;
		case LAGERIST:
			Lageristensteuerung ls = new Lageristensteuerung(null, benutzerReg, null, null); // TODO Fehlende
																								// Parameter
			System.out.println("Lagerist angemeldet!");
			break;
		case INHABER:
			Inhabersteuerung is = new Inhabersteuerung((Inhaber) benutzer, null, benutzerReg, null); // TODO Fehlende
																										// Parameter
